...
디지털 합성은 오늘날 미디어의 시각효과에서 필수적인 부분이고, 시각효과는 전세계 엔터테이먼트 산업 어디에나 존재한다.
...
/*/*그렇기에 디지털 합성은 예술적 도전이자 기술적 도전이라고 할 수 있다./*/*
__디지털 합성은 모든 시각 효과에 핵심적인 역할을 한다.__
...
## __1.첫번째는 CGI를 사용한 디지털 컴포지팅이다.__ CGI는 물체가 생성되어 현장에 합성되는 간단한 CGI 합성이다.
...
2.__두번째는 현대적인 컴포지팅 프로그램만으로 이루어지는 시각 효과의 많은 다양한 적용이다.__(_CGI를 필요X_)
+ 2-1. 블루 스크린
