...
+ LUT(Look-Up Table)는 특정 RGB 영상 값을 소스 이미지로 가져와서 해당 소스 이미지의 색, 포화 및 밝기 값을 변경하여 새로운 RGB 값으로 수정하는 수학적으로 정확한 방법이다.
...
##### + LUT는 영상을 할 수 있는 능력을 가진 어떤 프로그램에서도 사용될 수 있다. 
...
http://www.thevideomode.com/tuition/what-is-a-lut-3036/

https://mixinglight.com/color-grading-tutorials/understanding-luts/
